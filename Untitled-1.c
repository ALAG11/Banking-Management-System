...
void edit(void)
{
    ...
    while(fscanf(old,"%d %s %d/%d/%d %d %s %s %lf %s %f %d/%d/%d",&add.acc_no,add.name,&add.dob.month,&add.dob.day,&add.dob.year,&add.age,add.address,add.citizenship,&add.phone,add.acc_type,&add.amt,&add.deposit.month,&add.deposit.day,&add.deposit.year)!=EOF)
    {
        ...
        {   test=1;
            printf("\nWhich information do you want to change?\n1. Address\n2. Phone\n\nEnter your choice(Choose '1' for address and '2' for phone): ");
            scanf("%d",&choice);
            system("cls");
            if(choice==1)
...
{   int choice;
    ...
    system("color 2");
    printf("\n\n\t\t\t\t\t\t\t!!** ALOK BANK OF INDIA **!!");
    printf("\n\n\n\t\t\t\t\t\xB1\xB1\xB1\xB1\xB1\xB1\xB1 WELCOME TO THE MAIN MENU OF ALOK BANKING SYSTEM \xB1\xB1\xB1\xB1\xB1\xB1\xB1");
    printf("\n\n\t\t1. Create a new account\n\t\t2. Update the information of an existing account\n\t\t3. For doing the transactions\n\t\t4. Check the details of an existing account\n\t\t5. Removing an existing account\n\t\t6. View customer's list\n\t\t7. Exit from the banking portal\n\n\n\n\n\t\t --> Enter your choice: ");
    scanf("%d",&choice);
    system("cls");
    switch(choice)
    {
...
int main()
{
    ...
    printf("\t\t\t\t\t\tALOK BANK OF INDIA LOGIN PANEL");
    printf("\n\t\t\t\t\t\t******************************");
    char pass[10],password[10]="Alok";
    int i=0;
    ...
    if (strcmp(pass,password)==0)
        ...
        {   printf("\n\nWrong password!!\a\a\a");
            login_try:
            printf("\nEnter 1 to try again and 2 to exit: ");
            scanf("%d",&main_exit);
            if (main_exit==1)
                    {
